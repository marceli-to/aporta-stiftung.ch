...
return [
    ...
    'attributes' => [
        ...
        'household_info.total_persons' => 'Anzahl Personen',
        'household_info.adults_count' => 'Anzahl Erwachsene',
        'household_info.children_count' => 'Anzahl Kinder',
        'household_info.all_children_live_constantly' => 'Leben alle Kinder ständig mit Ihnen zusammen?',
        'household_info.has_pets' => 'Haustiere',
        'household_info.pets_description' => 'Haustiere (Beschreibung)',
        'household_info.remarks' => 'Bemerkungen',

        'children.*.position' => 'Kind',
        'children.*.birth_year' => 'Geburtsjahr',

        'main_applicant.salutation' => 'Anrede',
        'main_applicant.first_name' => 'Vorname',
        'main_applicant.last_name' => 'Familienname',
        'main_applicant.street' => 'Strasse',
        'main_applicant.street_number' => 'Hausnummer',
        'main_applicant.postal_code' => 'PLZ',
        'main_applicant.city' => 'Ort',
        'main_applicant.birth_date' => 'Geburtsdatum',
        'main_applicant.marital_status' => 'Familienstand',
        'main_applicant.nationality' => 'Nationalität',
        'main_applicant.place_of_origin' => 'Heimatort',
        'main_applicant.residence_permit' => 'Niederlassungsbewilligung',
        'main_applicant.swiss_residence_since' => 'In der Schweiz wohnhaft seit',
        'main_applicant.mobile_phone' => 'Mobiltelefon',
        'main_applicant.landline_phone' => 'Telefon (Festnetz)',
        'main_applicant.email' => 'E-Mail-Adresse',
        'main_applicant.occupation' => 'Beruf',
        'main_applicant.employment_status' => 'Erwerbssituation',
        'main_applicant.debt_enforcement_last_2y' => 'Betreibungen/Verlustscheine (letzte 2 Jahre)',
        'main_applicant.employer.name' => 'Aktuelle*r Arbeitgeber*in',
        'main_applicant.employer.workload_percent' => 'Arbeitspensum (in Prozent)',
        'main_applicant.employer.annual_income_bracket' => 'Jahreseinkommen (in CHF)',
        'main_applicant.current_housing.tenant_role' => 'Aktuelle Wohnsituation',
        'main_applicant.current_housing.terminated_by_landlord' => 'Kündigung durch Vermieter*in',
        'main_applicant.current_housing.termination_reason' => 'Kündigungsgrund',
        'main_applicant.current_housing.landlord_name' => 'Aktuelle*r Vermieter*in',
        'main_applicant.current_housing.landlord_contact_person' => 'Vermieter*in Kontaktperson',
        'main_applicant.current_housing.landlord_phone' => 'Vermieter*in Telefon',

        'co_applicant.salutation' => 'Anrede',
        'co_applicant.first_name' => 'Vorname',
        'co_applicant.last_name' => 'Familienname',
        'co_applicant.same_address_as_main' => 'Aktuell gleiche Adresse wie Hauptperson?',
        'co_applicant.street' => 'Strasse',
        'co_applicant.street_number' => 'Hausnummer',
        'co_applicant.postal_code' => 'PLZ',
        'co_applicant.city' => 'Ort',
        'co_applicant.birth_date' => 'Geburtsdatum',
        'co_applicant.marital_status' => 'Familienstand',
        'co_applicant.nationality' => 'Nationalität',
        'co_applicant.place_of_origin' => 'Heimatort',
        'co_applicant.residence_permit' => 'Niederlassungsbewilligung',
        'co_applicant.swiss_residence_since' => 'In der Schweiz wohnhaft seit',
        'co_applicant.mobile_phone' => 'Mobiltelefon',
        'co_applicant.landline_phone' => 'Telefon (Festnetz)',
        'co_applicant.email' => 'E-Mail-Adresse',
        'co_applicant.occupation' => 'Beruf',
        'co_applicant.employment_status' => 'Erwerbssituation',
        'co_applicant.debt_enforcement_last_2y' => 'Betreibungen/Verlustscheine (letzte 2 Jahre)',
        'co_applicant.employer.name' => 'Aktuelle*r Arbeitgeber*in',
        'co_applicant.employer.workload_percent' => 'Arbeitspensum (in Prozent)',
        'co_applicant.employer.annual_income_bracket' => 'Jahreseinkommen (in CHF)',
        'co_applicant.current_housing.tenant_role' => 'Aktuelle Wohnsituation',
        'co_applicant.current_housing.terminated_by_landlord' => 'Kündigung durch Vermieter*in',
        'co_applicant.current_housing.termination_reason' => 'Kündigungsgrund',
        'co_applicant.current_housing.landlord_name' => 'Aktuelle*r Vermieter*in',
        'co_applicant.current_housing.landlord_contact_person' => 'Vermieter*in Kontaktperson',
        'co_applicant.current_housing.landlord_phone' => 'Vermieter*in Telefon',
    ],

    // Nested (not dotted) so the translator's dot-traversal resolves them, and
    // keyed by the interpolated value: boolean true -> "1", false -> "".
    'values' => [
        'household_info' => [
            'has_pets' => ['1' => 'Ja'],
        ],
        'main_applicant' => [
            'nationality' => ['CH' => 'Schweiz'],
            'current_housing' => [
                'terminated_by_landlord' => ['1' => 'Ja'],
            ],
        ],
        'co_applicant' => [
            'nationality' => ['CH' => 'Schweiz'],
            'same_address_as_main' => ['' => 'Nein'],
            'current_housing' => [
                'terminated_by_landlord' => ['1' => 'Ja'],
            ],
        ],
