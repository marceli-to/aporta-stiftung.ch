...
class RegisterStoreRequest extends FormRequest
{
  ...
  public function rules()
  {
    return [
      ...
      'sub_tenant_postal_code_city' => 'required_if:sub_tenant_same_adress,0',
      ...
      'accomodation_total_persons' => 'required_if:sub_tenant_yn,1',
      'accomodation_adults_qty' => 'required_if:sub_tenant_yn,1',
