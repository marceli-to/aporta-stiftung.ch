...
class RegisterStoreRequest extends FormRequest
{
  ...
  public function rules()
  {
    return [
      ...
      'sub_tenant_salutation' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_lastname' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_firstname' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_same_adress' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      ...
      'sub_tenant_birthdate' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_marital_status' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_nationality' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      ...
      'sub_tenant_home_town' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_nationality,CH',
      'sub_tenant_private_phone' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_email' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_occupation' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_employment_status' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_debt_enforcement_yn' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_current_rent_tenant_role' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_current_rent_terminator' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_current_renter_name' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_current_renter_phone' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
      'sub_tenant_current_renter_rent_duration' => 'required_if:sub_tenant_yn,Ja|required_if:sub_tenant_type,!=Kinder',
  ...
  {
    return [
      // create error messages in german, like: 'main_tenant_salutation.required' => 'Bitte wählen Sie eine Anrede aus.',
