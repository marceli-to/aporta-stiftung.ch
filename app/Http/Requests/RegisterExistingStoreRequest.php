...
class RegisterExistingStoreRequest extends FormRequest
{
  ...
  public function rules()
  {
    return [
      ...
      'sub_tenant_salutation' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_lastname' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_firstname' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_birthdate' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_marital_status' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_nationality' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      ...
      'sub_tenant_home_town' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4,sub_tenant_nationality,CH',
      'sub_tenant_email' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_private_phone' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_occupation' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
      'sub_tenant_employment_status' => 'required_if:has_sub_tenant,true,sub_tenant_type,1,2,3,4',
